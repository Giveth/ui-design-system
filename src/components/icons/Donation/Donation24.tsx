...
export const IconDonation24: FC<IIconProps> = ({
	...
	>
		...
		/>
		<path
			d='M6.67444 9.98837H17.3256C19.8109 9.98837 21.8256 12.0031 21.8256 14.4884V20.4419C21.8256 21.8226 20.7063 22.9419 19.3256 22.9419H4.67444C3.29372 22.9419 2.17444 21.8226 2.17444 20.4419V14.4884C2.17444 12.0031 4.18916 9.98837 6.67444 9.98837Z'
			stroke={color}
		/>
