...
export const IconX: FC<IIconProps> = ({ size = 16, color='currentColor' }) => {
    ...
    <path d="M24 8L8 24M8 8L24 24" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
