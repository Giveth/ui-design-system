...
export const IconCaretUp: FC<IIconProps> = ({
	...
	const size32 = (
		...
		>
			<path
				d='M6.99986 20.1645L14.9628 9.8625C15.0912 9.69654 15.2504 9.56332 15.4296 9.47198C15.6087 9.38064 15.8036 9.33335 16.0008 9.33335C16.198 9.33335 16.3928 9.38064 16.572 9.47198C16.7512 9.56332 16.9104 9.69654 17.0387 9.8625L25.0017 20.1645C25.7616 21.1478 25.1316 22.6667 23.9637 22.6667H8.03553C6.86769 22.6667 6.23763 21.1478 6.99986 20.1645Z'
				fill={color}
			/>
		</svg>
	);
