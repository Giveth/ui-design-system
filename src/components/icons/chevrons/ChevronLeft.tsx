...
export const IconChevronLeft: FC<IIconProps> = ({ size = 16, color='currentColor' }) => {
    ...
    <path d="M20 24L12 16L20 8" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
