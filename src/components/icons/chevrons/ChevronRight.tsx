...
export const IconChevronRight: FC<IIconProps> = ({ size = 16, color='currentColor' }) => {
    ...
    <path d="M12 8L20 16L12 24" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
